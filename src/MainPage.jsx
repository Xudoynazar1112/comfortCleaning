    ...
    <div id="main" className="md:grid md:grid-cols-2 mt-8">
      <div id="main-right" data-aos="fade-up" className="flex flex-col justify-between mt-24">
        <div className="flex flex-col justify-center p-10">
          <h1 className="text-white text-[100px] text-wrap md:text-[#04A2BA] md:font-medium font-unbounded md:text-[70px]">
            {t("AppjsxH1")}
          </h1>
          <div className='flex relative'>
            <p className="text-white text-3xl mt-10 md:text-xl md:text-[#272121] font-normal md:w-[56%]">
            {t("AppjsxP")}
            </p>
            <img
